...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pose_tracker = avatar_vision.pose_tracker:main',
            'camera_depth_pub = avatar_vision_pose.camera_depth_pub:main',
            'yolo_3d_tracker = avatar_vision.yolo_3d_tracker:main',
        ],
    },
)
